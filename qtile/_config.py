...
keys = [
        ### The essentials
         ...
         ### Stack controls
         Key([mod, "mod1"], "h", lazy.layout.previous(),desc='Move up a section in stack'),
         Key([mod, "mod1"], "l", lazy.layout.next(),desc='Move up a section in stack'),
         ...
         # CHANGE FOCUS
         Key([mod], "Up", lazy.layout.up(),desc='Move up'),
         Key([mod], "Down", lazy.layout.down(),desc='Move Down'),
         Key([mod], "Left", lazy.layout.left(),desc='Move Left'),
         Key([mod], "Right", lazy.layout.right(),desc='Move Right'),
       ...
       # Media hotkeys
        ...
        Key([], 'XF86AudioLowerVolume',lazy.spawn('amixer -D pulse sset Master 1%-'),desc='Decrease volume'),
...
for i, (k, group) in enumerate(zip(group_keys, groups)):
    keys.extend([
        ...
        Key([mod], group_keyspad[i], lazy.group[group.name].toscreen()),
